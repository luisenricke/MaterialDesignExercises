    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener {
            var list : ArrayList<Option> = arrayListOf(
                Option("Take picture", R.drawable.ic_android_black_24dp),
                Option("Select from gallery",R.drawable.ic_android_black_24dp)
            )
            val menuFragment = MenuFragment.newInstance(list)
